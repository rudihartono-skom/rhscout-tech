    ...
    <div class="card">
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col-md-6">
                    Formulir Edit Product PT. RhScout Technology</div>
        ...
        <div class="card-body">
            <form action="/updateproduct/{{ $product->id }}" class="row" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" value="{{ $product->product }}" class="form-control" name="product" id="nm"
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" value="{{ $product->price }}" class="form-control" name="price" id="email"
                        placeholder="Masukan Price Product">
                </div>
                <div class="mb-3 col-md-6">
                    <label for="pass" class="form-label">Stock</label>
                    <input type="text" value="{{ $product->stock }}" class="form-control" name="stock" id="pass"
                        placeholder="Masukan Stock Product">
                </div>
                <div class="mb-3 col-md-6">
                    <label for="nohp" class="form-label">Suplayer</label>
                    <input type="text" value="{{ $product->suplayer }}" class="form-control" name="suplayer"
                        id="nohp" placeholder="Masukan Suplayer">
                </div>
                <div class="mb-3 col-md-6">
                    <label for="ft" class="form-label">Product Image</label>
                    <input type="file" class="form-control" value="{{ $product->product_image }}"
                        name="product_imageOld">
